...
CONSTRAINT FK1_DEPARTAMENTOS FOREIGN KEY(numce) 
 ...
 ON DELETE CASCADE);
 -- add foreign key
ALTER TABLE DEPARTAMENTOS ADD CONSTRAINT FK2_DEPARTAMENTOS 
FOREIGN KEY(depde) 
REFERENCES DEPARTAMENTOS(numde); 
-- Crear la tabla EMPLEADOS
CREATE TABLE EMPLEADOS( Numem NUMBER(3) NOT NULL, 
 Extel NUMBER(3), 
 Fecna DATE, 
 Fecin DATE, 
 Salar NUMBER(5), 
...
INSERT INTO EMPLEADOS 
VALUES(270,800,'21/05/1975','10/09/2003',1910,80,3,'OCTAVIO',112); INSERT INTO
EMPLEADOS 
...
order by nomde;
--ejercicio2:
select numde|| '-'||nomde AS "Número-nombre",tidir AS "T" 
from departamentos 
where presu <30 order by numde;

--ejercicio3:
select  nomem,salar*12 as "Salario 2014",salar*12*1.02 as "Salario 2015",salar*12*1.02*1.02 as "Salario 2016" 
from empleados 
where numhi >4 
order by nomem;
--ejercicio4:
